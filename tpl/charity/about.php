...
<ul><p>Асноўная інфармацыя, якую трэба ведаць, каб далучыцца да платформы “Інструмент удзелу”:</p> </br>
	...
	<p>Старонка са сціслым апісаннем законапраекта “Аб грамадска карыснай дзейнасці”, які абмяркоўваецца на дадзенай платформе. Падрабязная інфармацыя пра дзейную версію законапраекта, агульная стратэгія распрацоўкі і прасоўвання законапраекта на дзяржаўны ўзровень. </p></li></br>
	...
	<li class="li-static"> <a href = 'http://falanster.by/be/help' target = '_blank'><h3 class="h3-title">Ахвяраваць праекту</h3></a>
