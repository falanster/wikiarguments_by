...
<ul>Асноўная інфармацыя, якую трэба ведаць, каб далучыцца да платформы “Інструмент удзелу”:
	<li> <a href = '<?php echo $sTemplate->getRoot(); ?>usage-manual/'><p class="h3-title">Як карыстацца сістэмай </p> </a>
	...
	<li> <a href = '<?php echo $sTemplate->getRoot(); ?>discussion/'><p class="h3-title">Што абмяркоўваем </p> </a>
	...
	<li> <a href = '<?php echo $sTemplate->getRoot(); ?>license/'><p class="h3-title">Правілы і ліцэнзіі </p></a>
	...
	<li> <a href = 'http://falanster.by/be/help' target = '_blank'><p class="h3-title">Ахвяраваць праекту</p></a>
