      ...
      <div class = "new_question">
        ...
        <div class = "row">
          ...
          <div class = "input full_width" id = "input_new_group_title">
            <input id = "new_group_title" name = "new_group_title" maxlength="<?phpecho MAX_GROUP_NAME_CHR_LENGTH ?>" /><br />
            <span class="characters_left"><span id="new_group_title_chars_left"><?phpecho MAX_GROUP_NAME_CHR_LENGTH ?></span> <?php echo $sTemplate->getString("CHARS_WRITTEN_LEFT"); ?> </span>
          </div>
        </div>
