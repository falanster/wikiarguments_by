...
<div id = "content_wide">
  <div class = "thin">
	...
	<h3>Ліцэнзія</h3>
	<ul>
		<li>Усе каментары, заўвагі, прапановы, выкладзеныя ў Інструменце Ўдзелу, знаходзяцца ў грамадскім здабытку. Гэта значыць, ўсе абмеркаванні можна свабодна выкарыстоўваць са спасылкай на аўтара электроннага ўдзелу.</li>
