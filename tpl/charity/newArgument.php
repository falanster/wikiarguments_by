      ...
      <div class = "new_argument">
        ...
        <div class = "row">
          ...
          <div class = "input">
            ...
            <span class="characters_written"><span id="argument_details_chars_written">0</span> <?php echo $sTemplate->getString("CHARS_WRITTEN"); ?></span>
          </div>
        </div>

        <div class = "row row_submit">
        <button class = "button_orange" id = "buttonSubmit" onclick = "wikiargument.submitArgument('#new_argument', '#buttonSubmit'); return false;"><?php echo $sTemplate->getString("SUBMIT_NEW_ARGUMENT"); ?></button>
        </div>
