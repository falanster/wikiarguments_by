...
<ul>Асноўная інфармацыя, якую трэба ведаць, каб далучыцца да платформы “Інструмент удзелу”:
	<li> <a href = '<?php echo $sTemplate->getRoot(); ?>usage-manual/'><h3 class="h3-title">Як карыстацца сістэмай </h3> </a>
	...
	<li> <a href = '<?php echo $sTemplate->getRoot(); ?>discussion/'><h3 class="h3-title">Што абмяркоўваем </h3> </a>
	...
	<li> <a href = '<?php echo $sTemplate->getRoot(); ?>license/'><h3 class="h3-title">Правілы і ліцэнзіі </h3></a>
	...
	<li> <a href = 'http://falanster.by/be/help' target = '_blank'><h3 class="h3-title">Ахвяраваць праекту</h3></a>
