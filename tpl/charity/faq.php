...
<?php echo $sTemplate->getString("FAQ"); ?>
...
<ol>
<li>Пачнем з рэгістрацыі: робіцца гэта вельмі проста. Заходзім на адмысловую старонку, прыдумляем лагін і пароль, уводзім іх у адпаведныя радкі.</li>
...
<p>Калі ў вас засталіся пытанні, заўвагі або прапановы – смела пішыце нам на паштовую скрыню <a href = 'mail:falanster.by@gmail.com'>falanster.by@gmail.com</a>,. Абяцаем адгукнуцца і ўсё вырашыць як мага хутчэй. Удзельнічайце!</p>
