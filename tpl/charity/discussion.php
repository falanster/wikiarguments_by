...
<p><a href="<?php echo $sTemplate->getRoot(); ?>tpl/charity/img/plan/time_line_test.png" target="_blank"><img src="<?php echo $sTemplate->getRoot(); ?>tpl/charity/img/plan/time_line_1.png" style="min-width: 760px; width: 80%"></a></p>
